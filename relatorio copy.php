...
<body>
	...
	<div class="container">
		...
		<div class="container-tabelas">
			<table id="equipe">
				<thead>
					<tr>
						...
						<th title="Marque essa caixa caso a seja aceita a justificativa para a meta não ser ter sido atingida">Aceita?</th>
					</tr>
				</thead>
				<tr>
			...
			<table id="internacao" class="invisivelX">
				<thead>
			...
			<table id="ambulatorio" class="invisivelX">
				<thead>
			...
			<table id="consultas_ambulatoriais" class="invisivelX">
				<thead>
					<caption>A conveniada deverá realizar no mínimo 2850 saídas hospitalares trimestrais, conforme distribuição de acordo com o número de leitos existentes</caption>
				</thead>
				<tr>
			...
			<table id="procedimentos_e_cirurgias" class="invisivelX">
				<thead>
					<caption>A conveniada deverá realizar no mínimo 2850 saídas hospitalares trimestrais, conforme distribuição de acordo com o número de leitos existentes</caption>
				</thead>
				<tr>
			...
			<table id="sadt" class="invisivelX">
				<thead>
					<caption></caption>
				</thead>
				<tr>
			...
			<table id="atenção_domiciliar" class="invisivelX">
				<thead>
					<caption>..</caption>
				</thead>
				<tr>
