...
function defineDefaultLanguage ()
{
	...
	switch ( $_SESSION['selectedLanguage']) {
		case 'AR':		$idioma = 'arabe';		break;
		case 'DE':		$idioma = 'alemao';		break;
		case 'en-US':	$idioma = 'ingles';		break;
		case 'ES':		$idioma = 'espanhol';	break;
		case 'FR':		$idioma = 'frances';	break;
		case 'JP':		$idioma = 'japones';	break;
		case 'pt-BR':	$idioma = 'portugues';	break;
		case 'RU':		$idioma = 'russo';		break;
		default:		$idioma = '';
	}
	return $idioma;
}
